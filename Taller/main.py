...
print()
datos=extraer.extraer_informacion("Taller_herencia.xlsx")
# print(extraer.ordenar_por_edades(datos))
print(extraer.determinar_promedio(datos))
# print(extraer.ordenar_por_nombres(datos))
# print()
# print()
# print()
# print()
